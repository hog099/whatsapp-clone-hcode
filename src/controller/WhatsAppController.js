            ...
            if (this.el.inputDocument.files.length) {
                ...
                this._documentPreviewController.getPreviewData().then(result=>{
                    ...
                    switch (file.type){
                        ...
                        case 'application/vnd.openxmlfromats-officedocument.spredsheetml.sheet':
                         this.el.iconPanelDocumentPreview.classname = 'jcxhw icon-doc-xls';
                        break;

                        case 'application/vnd.ms-powerpoint':
                        case 'application/vnd.openxmlfromats-officedocument.presentationml.presentation':
                            this.el.iconPanelDocumentPreview.classname = 'jcxhw icon-doc-ppt';
                        break;

                        case 'application/msword':
                        case 'application/vnd.openxmlfromats-officedocument.wordprocessingml.document':
